...
[Real-Time View-Dependent Rendering of Parametric Surfaces](https://dl.acm.org/doi/10.1145/1507149.1507172)

- 这一篇是ETER引用的文献，ETER没有采用自适应细分而是uiform细分，是他声称即便这么做能够显著减少三角形数量，但是没有性能优势。
  - 我个人比较怀疑这个结论
- 阅读中几个confuse的点：
...
- 这一篇是ETER引用的文献，ETER主要援引了此文中对error的定义，并没有采用此文的刷案发，ETER paper的补充材料中指出，这篇文章有点bug，并且不适用于有理贝塞尔的情况。
- slefe
